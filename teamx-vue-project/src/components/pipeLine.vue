<template>
  <div>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="image-container">
          ...
          <!-- 각 영역에 대한 임시 테두리 박스 추가 -->
          <div class="area-box" style="top: 120px; left: 0px; width: 90px; height: 160px;" @click="scrollTo('mv기획')"></div>
          <div class="area-box" style="top: 120px; left: 130px; width: 160px; height: 45px;" @click="scrollTo('촬영')"></div>
          <div class="area-box" style="top: 120px; left: 325px; width: 160px; height: 45px;" @click="scrollTo('딥페이크 작업')"></div>
          <div class="area-box" style="top: 120px; left: 520px; width: 160px; height: 45px;" @click="scrollTo('PLATE 준비 작업')"></div>
          <div class="area-box" style="top: 120px; left: 715px; width: 160px; height: 45px;" @click="scrollTo('3D 프로덕션')"></div>
          <div class="area-box" style="top: 238px; left: 130px; width: 160px; height: 45px;" @click="scrollTo('AI 보컬 학습')"></div>
          <div class="area-box" style="top: 238px; left: 325px; width: 160px; height: 45px;" @click="scrollTo('소스 보컬 녹음')"></div>
          <div class="area-box" style="top: 238px; left: 520px; width: 160px; height: 45px;" @click="scrollTo('AI 보컬 변환')"></div>
          <div class="area-box" style="top: 238px; left: 715px; width: 160px; height: 45px;" @click="scrollTo('음원 믹싱')"></div>
          <div class="area-box" style="top: 120px; left: 905px; width: 90px; height: 160px;" @click="scrollTo('MV 제작')"></div>

          <div class="area-box" style="top: 330px; left: 0px; width: 90px; height: 100px;" @click="scrollTo('서브 듀엣곡 제작')"></div>
          <div class="area-box" style="top: 357px; left: 130px; width: 160px; height: 45px;" @click="scrollTo('서브 듀엣곡 제작')"></div>
          <div class="area-box" style="top: 357px; left: 325px; width: 160px; height: 45px;" @click="scrollTo('서브 듀엣곡 제작')"></div>
          <div class="area-box" style="top: 357px; left: 520px; width: 160px; height: 45px;" @click="scrollTo('서브 듀엣곡 제작')"></div>
          <div class="area-box" style="top: 357px; left: 715px; width: 160px; height: 45px;" @click="scrollTo('서브 듀엣곡 제작')"></div>

          <div class="area-box" style="top: 482px; left: 0px; width: 160px; height: 45px;" @click="scrollTo('브랜딩')"></div>
          <div class="area-box" style="top: 482px; left: 195px; width: 160px; height: 45px;" @click="scrollTo('브랜딩')"></div>
          <div class="area-box" style="top: 482px; left: 390px; width: 160px; height: 45px;" @click="scrollTo('브랜딩')"></div>
          <div class="area-box" style="top: 482px; left: 585px; width: 180px; height: 45px;" @click="scrollTo('브랜딩')"></div>

          <div class="area-box" style="top: 597px; left: 130px; width: 355px; height: 45px;"  @click="scrollTo('웹 디자인')"></div>
          <div class="area-box" style="top: 597px; left: 520px; width: 355px; height: 45px;"  @click="scrollTo('웹 개발')"></div>
        </div>
      </div>
      <div class="sections">
        <div>
    ...
    <img class="go-up" src="@/assets/img/goUp.png" alt="" @click="scrollToTop">
